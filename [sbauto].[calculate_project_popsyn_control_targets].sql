...
/****** Object:  UserDefinedFunction [sbauto].[calculate_project_popsyn_control_targets]    Script Date: 4/23/2019 9:06:27 PM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<This function has been modified to correct 2 types of errors>
-- at taz level, all targets of population breakdown were wrong, below is one example:WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[male_sf] / [region_controls_distribution].[hh_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]    
-- at taz level target, certain taz was missing after join with luz: use the left outer join to replace the inner join 
-- =============================================

CREATE FUNCTION
	[sbauto].[calculate_project_popsyn_control_targets] 
(
	@popsyn_run_id int 
...
(
	SELECT 
		...
		,[male] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[male_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]    --corrected by YMA, 4/16/2018
                        --previous wrong example:WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[male_sf] / [region_controls_distribution].[hh_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]    --previous errors
						ELSE NULL END + 
						CASE
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[male_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[male_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]    --corrected by YMA, 4/16/2018							
						ELSE NULL END + 
						CASE
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[male_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[male_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]    --corrected by YMA, 4/16/2018
						ELSE NULL END
					, 0) AS int)
		,[female] = CAST(ROUND
					(
				        ...
				        WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[female_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						...
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[female_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[female_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[female_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[female_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_0_17] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_0_17_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_0_17_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_0_17_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_0_17_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_0_17_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_18_24] =	CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_18_24_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_18_24_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_18_24_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_18_24_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_18_24_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_25_34] =	CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_25_34_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_25_34_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_25_34_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_25_34_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_25_34_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_35_49] =	CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_35_49_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_35_49_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_35_49_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_35_49_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_35_49_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_50_64] =	CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_50_64_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_50_64_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_50_64_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_50_64_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_50_64_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_65_79] =	CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_65_79_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_65_79_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_65_79_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_65_79_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_65_79_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[age_80plus] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[age_80plus_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[age_80plus_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[age_80plus_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[age_80plus_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[age_80plus_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[hisp] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[hisp_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[hisp_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[hisp_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[hisp_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[hisp_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[nhw] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[nhw_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[nhw_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[nhw_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[nhw_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[nhw_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[nhb] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[nhb_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[nhb_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[nhb_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[nhb_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[nhb_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[nho_popsyn] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[nho_popsyn_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[nho_popsyn_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[nho_popsyn_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[nho_popsyn_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[nho_popsyn_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
		,[nha] = CAST(ROUND
					(
						...
						WHEN [region_controls_distribution].[hh_sf] > 0 THEN (1.0 * [region_controls_distribution].[nha_sf] / [region_controls_distribution].[pop_non_gq_sf]) * [taz_level_override].[hh_sf] * [region_controls_distribution].[hhs_sf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mf] > 0 THEN (1.0 * [major_controls_distribution].[nha_mf] / [major_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [major_controls_distribution].[hhs_mf]
						WHEN [region_controls_distribution].[hh_mf] > 0 THEN (1.0 * [region_controls_distribution].[nha_mf] / [region_controls_distribution].[pop_non_gq_mf]) * [taz_level_override].[hh_mf] * [region_controls_distribution].[hhs_mf]
						ELSE NULL END + 
						CASE	
						WHEN [major_controls_distribution].[hh_mh] > 0 THEN (1.0 * [major_controls_distribution].[nha_mh] / [major_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [major_controls_distribution].[hhs_mh]
						WHEN [region_controls_distribution].[hh_mh] > 0 THEN (1.0 * [region_controls_distribution].[nha_mh] / [region_controls_distribution].[pop_non_gq_mh]) * [taz_level_override].[hh_mh] * [region_controls_distribution].[hhs_mh]
						ELSE NULL END
					, 0) AS int)
	FROM 
	(
	...
	Left Outer Join                                    --to replace INNER JOIN, YMA, 4/23/2018
